...
const sections = [
  {
    ...
    content: (
      <p>
        HMD Mail is an AI-powered email client that manages your inbox, so you don't have to. We help
  ...
  },
  {
    ...
    content: (
      <p>
        We started HMD Mail because we were frustrated that email — the most-used communication tool
        in the world — hasn't meaningfully evolved in decades. Despite countless new apps, none
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          HMD Mail is built on the principles of transparency and community collaboration. Our
          entire codebase is open source, allowing anyone to:
        </p>
        <ul className="ml-4 list-disc space-y-2">
          <li>Review our code for security and privacy</li>
          <li>Contribute improvements and new features</li>
          <li>Self-host their own instance of HMD Mail</li>
        ...
        <p>
          ...
          source, we ensure that HMD Mail remains transparent, trustworthy, and accessible to
          everyone.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Users want an assistant that streamlines their inbox, providing features to summarize
          emails, compose responses, and take necessary actions.
        </p>
        <p>
          The opportunity is massive: over 4 billion people use email daily, and most still manage
          it manually. HMD Mail is poised to fundamentally change the way the world deals with
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          The team behind HMD Mail comes from backgrounds in product design and software
          engineering, driven by a shared belief that email should help you move faster, not slow
          you down.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p>Want to learn more about HMD Mail? Get in touch:</p>
        <div className="flex flex-col space-y-2">
          <a
            href="mailto:support@hmdpublishing.com"
            className="inline-flex items-center text-blue-400 hover:text-blue-300"
          >
            <Mail className="mr-2 h-4 w-4" />
            support@hmdpublishing.com
          </a>
          <a
